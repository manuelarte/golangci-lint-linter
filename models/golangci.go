...
func (l YamlLinters) GetEnable() ([]string, bool) {
	...
	return internal.Transform[string](enableInterface, anyToString)
}
...
func (l YamlLinters) GetDisable() ([]string, bool) {
	...
	return internal.Transform[string](disableInterface, anyToString)
}
...
func (l YamlLinters) sort(original []string, cmPath func(index int) string) ([]string, bool) {
	sorted, isSorted := internal.IsAlphabetical(original)
	if isSorted {
		return nil, false
	}
